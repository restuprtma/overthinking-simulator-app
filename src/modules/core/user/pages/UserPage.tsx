...
const UserPage: React.FC = () => {
  ...
  const { dialogState, openCreate, openEdit, reset: resetDialogState } = useDialogState<User>();
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', gap: 2, p: 3 }}>
      ...
      <Card sx={{ flexShrink: 0 }}>
        ...
        >
          <UserFilters
            ...
            onFullNameChange={handleFullNameFilter}
            onUsernameChange={handleUsernameFilter}
            onEmailChange={handleEmailFilter}
      ...
      >
        {/* Users Table with fixed header and scrollable body */}
        <UserTable
          users={users}
          isLoading={isLoading}
