...
import { STOCK_OPTIONS } from '../data/mock';
...
export function StockDateCard({ engine }: Props) {
  ...
  return (
    ...
    >
      <Autocomplete
        ...
        value={STOCK_OPTIONS.find((s) => s.code === code) ?? STOCK_OPTIONS[0]}
        onChange={(_, next) => {
        ...
        renderInput={(params) => <TextField {...params} label="Stock" placeholder="Search…" />}
      />
